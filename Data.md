...
| obs_index (experiment) | geo_id     | accession | sample_type | sample_type_confidence | mapped_ontology_ids                               | mapped_ontology_terms                             | real_value_property_ids | real_value_property_terms | sra_uid | biosample_uid | biosample_title                    | raw_biosample_metadata                            | organism          | biosample    | database | accession_type | sample    | study     | bioproject  | geo_metadata                         |
| ---------------------- | ---------- | --------- | ----------- | ---------------------: | ------------------------------------------------- | ------------------------------------------------- | ----------------------- | ------------------------- | ------: | ------------: | ---------------------------------- | ------------------------------------------------- | ----------------- | ------------ | -------- | -------------- | --------- | --------- | ----------- | ------------------------------------ |
